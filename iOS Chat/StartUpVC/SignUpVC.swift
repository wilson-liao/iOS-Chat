...
class SignUpVC: UIViewController {
    ...
    func goToSetUp() {
        ...
        let tabvc = TBController(user: user, loginEntry: self.loginEntry)
        let editvc = EditProfileVC(user:user, loginEntry: self.loginEntry)
        self.navigationController?.viewControllers = [tabvc, editvc]
    }
}
